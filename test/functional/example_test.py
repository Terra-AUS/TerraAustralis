...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the TerraAustralisTestFramework
    pass


class ExampleTest(TerraAustralisTestFramework):
    # Each functional test is a subclass of the TerraAustralisTestFramework class.
    ...
    def custom_method(self):
        ...
        TerraAustralisTestFramework class so other tests can use it."""
