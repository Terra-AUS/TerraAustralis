...
Tracing (USDT) support for TerraAustralis Core on Linux using. For more information on
USDT support in TerraAustralis Core see the [USDT documentation].
...
[TerraAustralis Core USDT documentation] on how to list available tracepoints in your
`bitcoind` binary.

[TerraAustralis Core USDT documentation]: ../../doc/tracing.md#listing-available-tracepoints
...
TerraAustralis P2P messages can be larger than 32kb (e.g. `tx`, `block`, ...). The
...
In a different terminal, starting TerraAustralis Core in SigNet mode and with
re-indexing enabled.
