...
Source100:	https://upload.wikimedia.org/wikipedia/commons/4/46/TerraAustralis.svg
...
%description
TerraAustralis is a digital cryptographic currency that uses peer-to-peer technology to
...
to run a TerraAustralis wallet, this is probably the package you want.
%endif


%package libs
Summary:	TerraAustralis shared libraries
...
%package utils
Summary:	TerraAustralis utilities
Group:		Applications/System
...
[Unit]
Description=TerraAustralis daemon
...
Encoding=UTF-8
Name=TerraAustralis
Comment=TerraAustralis P2P Cryptocurrency
Comment[fr]=TerraAustralis, monnaie virtuelle cryptographique pair à pair
Comment[tr]=TerraAustralis, eşten eşe kriptografik sanal para birimi
Exec=bitcoin-qt %u
Terminal=false
Type=Application
Icon=bitcoin128
...
getent passwd bitcoin >/dev/null ||
	...
	-c "TerraAustralis wallet server" bitcoin
exit 0
