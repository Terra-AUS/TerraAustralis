...
// Copyright (c) 2009-2020 The TerraAustralis Core developers
...
/** A hasher class for TerraAustralis's 256-bit hash (double SHA-256). */
class CHash256 {
private:
    CSHA256 sha;
public:
...
/** A hasher class for TerraAustralis's 160-bit hash (SHA-256 + RIPEMD-160). */
class CHash160 {
private:
    CSHA256 sha;
public:
