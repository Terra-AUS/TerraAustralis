// Copyright (c) 2011-2017 The TerraAustralis Core developers
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = fs::temp_directory_path() / strprintf("test_terraaustralis_%lu_%i", (unsigned long)GetTime(), (int)(InsecureRandRange(100000)));
