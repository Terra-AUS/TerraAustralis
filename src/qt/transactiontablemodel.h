...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, TerraAustralisUnits::SeparatorStyle separators=TerraAustralisUnits::SeparatorStyle::STANDARD) const;
