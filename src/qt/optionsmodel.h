...
/** Interface from Qt to configuration data structure for TerraAustralis client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // TerraAustralisUnit
    ...
    TerraAustralisUnit getDisplayUnit() const { return m_display_bitcoin_unit; }
...
private:
    ...
    QString language;
    TerraAustralisUnit m_display_bitcoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(TerraAustralisUnit unit);
