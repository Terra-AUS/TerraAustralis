This directory contains the source code for the TerraAustralis Core graphical user interface (GUI). It uses the [Qt](https://www1.qt.io/developers/) cross-platform framework.
...
- Represents the main window of the TerraAustralis UI.
...
* UI elements like TerraAustralisAmountField, which inherit from QWidget.
...
9. You're all set! Start developing, building, and debugging the TerraAustralis Core GUI
