...
def parse_config_into_btc_config():
    ...
    config_dict["PACKAGE_STRING"] = f"\"TerraAustralis Core {version}\""
...
def main():
    parser = argparse.ArgumentParser(description='TerraAustralis-core msbuild configuration initialiser.')
