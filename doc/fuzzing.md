# Fuzzing TerraAustralis Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing TerraAustralis Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
Every single pull request submitted against the TerraAustralis Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make TerraAustralis Core more robust.
...
with certain assembly code from TerraAustralis Core's code. See [developer notes on sanitizers](https://github.com/bitcoin/bitcoin/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing TerraAustralis Core using afl++

## Quickstart guide

To quickly get started fuzzing TerraAustralis Core using [afl++](https://github.com/AFLplusplus/AFLplusplus):
...
# Fuzzing TerraAustralis Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing TerraAustralis Core using [Honggfuzz](https://github.com/google/honggfuzz):
...
## Fuzzing the TerraAustralis Core P2P layer using Honggfuzz NetDriver

Honggfuzz NetDriver allows for very easy fuzzing of TCP servers such as TerraAustralis
...
# Fuzzing TerraAustralis Core using Eclipser (v1.x)

## Quickstart guide

To quickly get started fuzzing TerraAustralis Core using [Eclipser v1.x](https://github.com/SoftSec-KAIST/Eclipser/tree/v1.x):
...
TerraAustralis Core participates in Google's [OSS-Fuzz](https://github.com/google/oss-fuzz/tree/master/projects/bitcoin-core)
...
because TerraAustralis is a live P2P network, and not just standalone local software,
