...
Below are some notes on how to build TerraAustralis Core for Windows.

The options known to work for building TerraAustralis Core on Windows are:
...
Note that for WSL the TerraAustralis Core source path MUST be somewhere in the default mount file system, for
