...
The TerraAustralis Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in TerraAustralis Core requires the ZeroMQ API >= 4.0.0
...
using. TerraAustralisd appends an up-counting sequence number to each
