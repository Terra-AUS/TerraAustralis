TerraAustralis Core version 0.11.0 is now available from:
...
Block pruning allows TerraAustralis Core to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that TerraAustralis Core will 
...
- #5729 `9c4a5a5` Allow unit changes for read-only TerraAustralisAmountField
...
- #6116 `30dc3c1` [OSX] rename TerraAustralis-Qt.app to TerraAustralis-Core.app
